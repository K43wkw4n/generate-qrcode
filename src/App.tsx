...
const translations = {
  en: {
    ...
    heroSubtitle: 'Add a link, text, a center logo, and fine-tune the style before exporting your design.',
    placeholder: 'Paste a URL, text, or any content to turn into a QR code',
    ...
    preview: 'Preview',
    empty: 'Enter content to see your QR code preview',
    downloadPng: 'PNG',
    downloadJpg: 'JPG',
    downloadSvg: 'SVG',
    ...
    uploadCompatible: 'Works on computer, tablet & mobile',
  ...
  th: {
    title: 'สตูดิโอ QR',
    heroTitle: 'สร้าง QR Code ที่ดูดีและใช้งานง่ายในไม่กี่วินาที',
    heroSubtitle: 'ใส่ลิงก์หรือข้อความ เพิ่มโลโก้ตรงกลาง และปรับสไตล์ให้ตรงใจก่อนดาวน์โหลด',
    ...
    uploadCompatible: 'ทำงานได้บนคอม แท็บเล็ต และมือถือ',
